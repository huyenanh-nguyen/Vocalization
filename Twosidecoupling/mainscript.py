...
class TwosidedCoupling:
    ...
    Van der Pol:
        $\\ddot{x} - \\mu (1 - x^2) \\dot{x} + x = kxy$
    Duffing:
        $\\ddot{y} + \\gamma \\dot{y} + \\alpha y + \\beta y^3 = kxy$
    ...
    def duffvdpsolver(self):
        ...
        sol = odeint(linearduffingvdp, par, t, args = (k, mu, gamma, alpha, beta), rtol= 0.00001)
